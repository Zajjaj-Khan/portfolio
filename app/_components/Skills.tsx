...
import MobileDev from "./Skills/MobileDev";
...
export function IconCloudDemo() {
  return (
    <div className="m-8 pl-8 relative">
      <SkillBackground />
      <div>
        <h1 className={`text-3xl font-extrabold ${poppins.className}`}>
          Skills
        </h1>
        <h3
          className={`font-semibold  text-gray-400 md:px-8 py-4 pt-4 ${poppins.className}`}
        >
